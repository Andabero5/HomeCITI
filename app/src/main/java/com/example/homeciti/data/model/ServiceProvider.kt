...
class ServiceProvider {
    companion object {
        ...
        val services = mutableListOf(
            Service("Expedia","https://www.nicepng.com/png/full/395-3957278_expedia-png-get-started-expedia-logo-png.png","New","red"),
            Service("Pase","https://pbs.twimg.com/profile_images/725759818267422720/hYsLwrGg_400x400.jpg","",""),
            Service("Musica","https://w7.pngwing.com/pngs/727/579/png-transparent-app-store-music-itunes-computer-icons-apple-apple-purple-violet-text-thumbnail.png","New","red"),
            Service("Noticias","https://cdn.pixabay.com/photo/2018/10/26/09/24/news-3774160_960_720.png","",""),
            Service("Telcel","https://toppng.com/uploads/preview/telcel-digital-pcs-vector-logo-free-11574029807u5xja7ooh1.png","Favorite","blue"),
            Service("Prestamo","https://e7.pngegg.com/pngimages/711/287/png-clipart-payday-loan-money-bank-financial-services-give-money-text-service.png","New","red"),
            Service("Telmex","https://e7.pngegg.com/pngimages/347/142/png-clipart-logo-telmex-mobile-phones-font-aol-logo-text-logo.png","",""),
            Service("Cerca de mi","https://flyclipart.com/thumb2/flat-location-logo-icons-png-934757.png","New","red"),
            Service("Promos","https://e7.pngegg.com/pngimages/37/353/png-clipart-sales-promotion-discounts-and-allowances-computer-icons-marketing-public-relations-logo-thumbnail.png","",""),
            Service("Sky","https://image.pngaaa.com/738/2524738-middle.png","Favorite","blue"),
            Service("CFE","https://cpng.pikpng.com/pngl/s/365-3652622_cfe-logo-comision-federal-de-electricidad-png-sport.png","New","red"),
            Service("¿Que es Claro Pay?","https://play-lh.googleusercontent.com/5sTC1Sa7WI0SHwVK9dJo2hbq-JC-iUVW_ymmWnlinLlqZAf0yWqn_LJBC8p-scn03qk_","",""),
        )
